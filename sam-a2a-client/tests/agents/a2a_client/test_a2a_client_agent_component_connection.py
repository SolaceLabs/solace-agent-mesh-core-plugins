...
class TestA2AClientAgentComponentConnection(unittest.TestCase):
    ...
    @patch(
        "src.agents.a2a_client.a2a_client_agent_component.A2AClientAgentComponent._launch_a2a_process"
    )
    @patch(
        "src.agents.a2a_client.a2a_client_agent_component.A2AClientAgentComponent._wait_for_agent_ready",
        return_value=True,
    )
    ...
    def test_initialize_connection_launch_mode_success(
        ...
        mock_thread_cls.assert_called_once_with(
            target=component._monitor_a2a_process, daemon=True
        )
    ...
    @patch("src.agents.a2a_client.a2a_client_agent_component.A2ACardResolver")
    @patch(
        "src.agents.a2a_client.a2a_client_agent_component.A2AClient",
